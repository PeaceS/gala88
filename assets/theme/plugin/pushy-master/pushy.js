...
(function ($) {
	var pushy = $('.pushy'), //menu css class
        ...
        customCloseBtn = $('.pushy-close'), // Custom close button
	...
	if( typeof pushy.data('menu-btn-class') !== 'undefined' ){
		...
		var menuBtnClass = '.hamburger'; //set default menu button CSS class
	}
	...
	if(cssTransforms3d){
        ...
        //close menu when clicking custom close button
